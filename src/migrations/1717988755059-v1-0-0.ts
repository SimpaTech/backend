...
export class V1001717988755059 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`tipo_parametro\` (\`ID_Tipo_Parametro\` int NOT NULL AUTO_INCREMENT, \`Fator\` float NOT NULL, \`Offset\` float NOT NULL, \`Unidade\` varchar(255) NOT NULL, \`Json\` varchar(255) NOT NULL, \`Nome_Tipo_Parametro\` varchar(255) NOT NULL, \`Indicativo_Ativa\` tinyint NOT NULL, PRIMARY KEY (\`ID_Tipo_Parametro\`)) ENGINE=InnoDB`);
