...
export class Default1711738246004 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`usuario\` (\`ID_Usuario\` int NOT NULL AUTO_INCREMENT, \`Nome_Usuario\` varchar(255) NOT NULL, \`CPF_Usuario\` varchar(255) NOT NULL, \`Token\` varchar(255) NOT NULL, \`Senha\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_e8e6a306e71b43e9921f911e36\` (\`CPF_Usuario\`), PRIMARY KEY (\`ID_Usuario\`)) ENGINE=InnoDB`);
